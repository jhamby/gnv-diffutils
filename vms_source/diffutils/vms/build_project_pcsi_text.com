$! File: build_project_pcsi_text.com
$!
$! Build the *.pcsi$text file from the four components:
$!    1. Generated =product header section
$!    2. readme. file from the project distribution, modified to fit
$!       a pcsi$text file format.
$!    3. copying file from the project distribution, modified to fit
$!       a pcsi$text file format.
